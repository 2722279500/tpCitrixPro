        ...
        if(!empty($getAdminInfo))
        {
            ...
            if(!empty($getShowTopList))
            {
                ...
                foreach ($dataMenuList as $k1 => $v1) 
                {
                    ...
                    {
                        if($menuList1 = Db::name("menu")->field("id,name,module,controller,function,icon,is_open")->where(['is_display'=>1,'menu_cate_id'=>$menu_cate_id,'pid'=>0])->where('id','in',$menu_collect)->select())
                        {
                            $dataMenuList1 = [];
                            foreach ($menuList1 as $k2 => $v2) 
                            {
                                ...
                                $dataMenuList2 = [];
                                if($menuList2 = Db::name("menu")->field("id,name,module,controller,function,icon,is_open")->where(['is_display'=>1,'pid'=>$menuList1[$k2]['id'],'menu_cate_id'=>$menu_cate_id])->select())
                                {
