<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\PHPTutorial\WWW\layuicms/application/admin\view\index\indexmain.html";i:1563778486;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<title>后台管理模板tpCitrix Pro 1.0</title>
...
<body class="childrenBody">
	...
	<blockquote class="layui-elem-quote main_btn">
		tpCitrix Pro 1.0</br>
		内置thinkphp5.0+layuicms为核心，</br>
		作者自行添加了博客,数据备份,论坛,权限控制,文章等......</br>
	</blockquote>
			...
			<div class="layui-elem-quote layui-quote-nm history_box magb0">
				<ul class="layui-timeline">
					...
					<li class="layui-timeline-item">
						...
						<div class="layui-timeline-content layui-text">
							<div class="layui-timeline-title">
								<h3 class="layui-inline">tpCitrix Pro 1.0正式与大家见面，提供了一些简单功能　</h3>
								<span class="layui-badge-rim">2019-07-22</span>
							</div>
						</div>
					</li>
				</ul>
