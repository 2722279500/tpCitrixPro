<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\PHPTutorial\WWW\mianshi/application/admin\view\permission\index.html";i:1565072745;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="childrenBody">
    <blockquote class="layui-elem-quote">
        <button type="button" class="layui-btn" onclick="publish(this)" data-url="<?php echo url('admin/permission/publish'); ?>">新增</button>
    </blockquote> 
        ...
        <table class="layui-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo citrixGetMenuCateName($vo['menu_cate_id']); ?></td>
                    <td>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" onclick="publish(this)" data-url="<?php echo url('admin/permission/publish',['pid'=>$vo['id'],'menu_cate_id'=>$vo['menu_cate_id']]); ?>">&nbsp;+&nbsp;</button>
                        <?php endif; ?>
                        <button type="button" class="layui-btn layui-btn-xs" onclick="publish(this)" data-url="<?php echo url('admin/permission/publish',['id'=>$vo['id']]); ?>">编辑</button>
    ...
    <script type="text/javascript">
            ...
            $(document).on("click",".infoDelete",function()
            {
                ...
                layer.confirm('您确定要删除吗？', 
                {
                  btn: ['确定','取消']
                    ...
                    $.ajax({
                        url:"<?php echo url('admin/permission/infoDelete'); ?>",
                        data:{"id":id},
                        type:'post',
                        async: false,
                        dataType : 'json',
        ...
        { 
            var value = $(obj).val();
            $.ajax({
                url:"<?php echo url('admin/permission/changeTableVal'); ?>",
