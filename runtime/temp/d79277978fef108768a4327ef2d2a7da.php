<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\PHPTutorial\WWW\layuicms/application/admin\view\common\login.html";i:1563935922;}*/ ?>
<!DOCTYPE html>
		...
		layui.use(['form','layer','jquery'],function(){
		    var form = layui.form,
		        ...
		        layer.open({
					type: 1,
					area: ['420px', '170px'], //宽高
					content: '<div style="text-align: left;margin-left: 30px;line-height: 30px;margin-top: 15px;">测试账号：test@163.com</br>测试密码：123456</br>开源地址：<a href="https://github.com/2722279500/tpCitrixPro" target = "_blank">https://github.com/2722279500/tpCitrixPro</a></div>'
				});

			    //登录按钮
			    form.on("submit(login)",function(data){
			        $.ajax({
			            url:"<?php echo url('admin/common/loginPublish'); ?>",
